...
### Bias : 
Jokhon model underfit obosthay thake. Mane jokhon training error and validation error same pattern follow kore.

### Variance :
Jokhon model overfit obosthay thake. Mane jokhon training error and validation error different pattern follow kore.

### Regularization :
Regularization use kora hoe jate model overfit or underfit na kore.
